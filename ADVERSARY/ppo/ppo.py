...
class PPO:
    ...
    """
    def __init__(self, env, agent, policy_class, state_mean, state_std, name="", transfer=False, **hyperparameters):
        """
        ...
        self.actor = policy_class(self.obs_dim, self.act_dim, self.model_dim).to(self.device)                                                   # ALG STEP 1
    ...
    def learn(self, total_timesteps):
        ...
        while t_so_far < total_timesteps:                                                                       # ALG STEP 2
            ...
            if i_so_far % self.save_freq == 0:
                ...
                torch.save(self.critic.state_dict(), './ppo_critic_'+self.name+'.pth')
    ...
    def act(self, obs, reward, done):
        ...
        if self._next_attack_time is None:
            self._next_attack_time = self._attack_period#1 + np.random.randint(self._attack_period)
